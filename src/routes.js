...
const AddAdmin = React.lazy(() => import('./views/admin/Add'));
const ListAdmin = React.lazy(() => import('./views/admin/List'));
const AdminInfo = React.lazy(() => import('./views/admin/adminInfo'));

const UpdateAdmin = React.lazy(() => import('./views/admin/UpdateAdmin'));

const ListUser = React.lazy(() => import('./views/Users/List'));

const AddUser = React.lazy(() => import('./views/Users/Add'));

const AddPlug = React.lazy(() => import('./views/plugs/Add'));

const PlugList = React.lazy(() => import('./views/plugs/List'));

const UserInfo = React.lazy(() => import('./views/Users/userInfo'));

const UpdateUser = React.lazy(() => import('./views/Users/UpdateUser'));
const PlugInfo = React.lazy(() => import('./views/plugs/plugInfo'));

const UpdatePlug = React.lazy(() => import('./views/plugs/UpdatePlug'));
...
const routes = [
	...
	{ path: '/plug/info/:id', exact: true, name: 'Plug info', component: PlugInfo },
	{ path: '/plug/update/:id', exact: true, name: 'update_plugs', component: UpdatePlug },
	{ path: '/login', exact: true, name: 'login', component: Login },
	{ path: '/user/login', exact: true, name: 'user_login', component: UserLogin },
	{ path: '/admin/home', exact: true, name: 'admin dashboard', component: AdminDashboard },
];
