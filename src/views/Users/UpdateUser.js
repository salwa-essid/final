...
class UpdateUser extends Component {
  ...
  handleSubmit = () => {
    axios.put("http://127.0.0.1:5001/user", {
      id: this.state.id,
                      ...
                      <div className="row">
                        <div className="col-md-6">
                          <div className="form-group">
                            ...
                            <input type="text" name="firstname" id="firstname" className="form-control" value={this.state.username} placeholder="" aria-describedby="helpId" onChange={this.handleChange} />
